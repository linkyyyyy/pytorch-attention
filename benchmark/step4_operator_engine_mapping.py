...
PROVENANCE_BANNER_SECTION3 = (
    ...
    "NOT primary results/ CSVs. "
    "§3 is the committed production snapshot, validated as the rounded twin of the "
    "full-precision primary tower CSVs (energy-layer diff 83/83 numeric PASS + 1 expected-N/A, "
    "2026-06-17). This is the §3-rounded transcription table; the full-precision publication "
    "table is STEP4_OPERATOR_ENGINE_MAPPING_primary.md. VALIDATED status and supervisor "
    "sign-off: see PROJECT_CONTEXT.md §8."
)
PROVENANCE_BANNER_PRIMARY = (
    ...
    "Full-precision publication table; energy-layer diff 83/83 numeric PASS + 1 expected-N/A, "
    "2026-06-17. VALIDATED status: see PROJECT_CONTEXT.md §8."
)
